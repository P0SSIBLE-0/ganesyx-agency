...
export function TechIcon({ name }: TechIconProps) {
  switch (name.toLowerCase()) {
    ...
    case 'react':
      return (
        <svg viewBox="0 0 100 100" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="4">
    ...
    case 'framer motion':
      return (
        <svg viewBox="0 0 256 256" width="24" height="24" fill="currentColor">
          <path d="M0 0h256v128H128L0 0zm0 128h128l128 128H0V128zm256-128v128H128L256 0z" />
        </svg>
      );
    case 'node.js':
      return (
    ...
    case 'firebase':
      return (
        <svg viewBox="0 0 116 160" width="24" height="24" fill="currentColor">
          <path d="M19 123.6l1 1.7L59.2 24.3c1-2.4 4.5-2.4 5.5 0L76 51.5l-57 72.1zm80.2-.7L86 16c-.9-3-4.9-3.7-6.8-1.2L16.2 121c-2 2.6-.7 6.6 2.7 7.4L95.5 142c3.4.9 6.2-2.3 3.7-5.1z" />
        </svg>
      );
    case 'supabase':
      return (
